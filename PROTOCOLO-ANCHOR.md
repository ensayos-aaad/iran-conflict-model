...
## Iran Conflict Model (ICM) — Anclaje a Realidad y Declaración de Limitaciones
...
Ejecutar ANTES de cualquier otro input en cada sesión
═══════════════════════════════════════════════════════════════

ADVERTENCIA PERMANENTE — leer antes de continuar
───────────────────────────────────────────────────────────────
Este sistema produce análisis estructurado, no verdad verificada.
...
3. Completar esta frase con honestidad:
   "El argumento más sólido para que el análisis
   acumulado del ICM esté equivocado es..."
...
"¿Qué evidencia concreta y verificable cambiaría
 ...
 o solo procesamos la que llegó sola?"

Si la respuesta honesta es "no la hemos buscado
...
Una conclusión del modelo que fue útil.
...
Continuar ahora con el correo de recordatorio.
═══════════════════════════════════════════════════════════════
```
